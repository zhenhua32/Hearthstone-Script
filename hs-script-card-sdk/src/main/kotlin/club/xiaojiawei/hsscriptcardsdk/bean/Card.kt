...
import club.xiaojiawei.hsscriptcardsdk.enums.TargetEnum
...
class Card(
    ...
    /**
     * 能被敌方法术指向
     * 适用的卡牌类型：[CardTypeEnum.MINION], [CardTypeEnum.HERO]
     */
    ...
    /**
     * 获取能攻击的目标
     * 比如刚下场的突袭随从只能解场，此时返回[TargetEnum.MINION]
     */
    ...
    /**
     * 能使用/激活
     * 适用的卡牌类型：[CardTypeEnum.LOCATION], [CardTypeEnum.HERO_POWER], [CardTypeEnum.MINION]中的星舰
     */
    ...
    /**
     * 是否受伤
     * 适用的卡牌类型：[CardTypeEnum.MINION], [CardTypeEnum.HERO], [CardTypeEnum.WEAPON], [CardTypeEnum.LOCATION]
     */
